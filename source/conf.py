...
project = u'PloneGovBr-VirtualBox'
copyright = u'2013, svx'
...
html_theme_options = {
    'github_user': 'svx',
    'github_repo': 'PloneGovBr-VirtualBox',
    'twitter_username': 'der_sven_',
    'home_url': 'http://github.com/svx',
...
htmlhelp_basename = 'plonegovbr-vb-doc'
...
texinfo_documents = [
  ('index', 'test', u'test Documentation',
   u'svx', 'test', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'test'
epub_author = u'svx'
epub_publisher = u'svx'
epub_copyright = u'2013, svx'
